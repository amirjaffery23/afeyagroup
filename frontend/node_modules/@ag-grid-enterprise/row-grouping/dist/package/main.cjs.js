...
var AggregationStage = class extends import_core2.BeanStub {
  ...
  createAggDetails(params) {
    ...
    const aggDetails = {
      ...
      groupIncludeTotalFooter: !!(0, import_core2._getGrandTotalRow)(this.gos),
  ...
  isSuppressAggFilteredOnly() {
    const isGroupAggFiltering = (0, import_core2._getGroupAggFiltering)(this.gos) !== void 0;
...
var AutoColService = class extends import_core3.BeanStub {
  ...
  createAutoCols(rowGroupCols) {
    ...
    let doingMultiAutoColumn = (0, import_core3._isGroupMultiAutoColumn)(this.gos);
...
var FilterAggregatesStage = class extends import_core12.BeanStub {
  ...
  execute(params) {
    ...
    const applyFilterToNode = (0, import_core12._getGroupAggFiltering)(this.gos) || (isPivotMode2 ? defaultSecondaryColumnPredicate : defaultPrimaryColumnPredicate);
...
// enterprise-modules/row-grouping/src/rowGrouping/groupStage/groupStrategy/groupStrategy.ts
var GroupStrategy = class extends import_core15.BeanStub {
  wireBeans(beans) {
    this.beans = beans;
    this.columnModel = beans.columnModel;
    this.funcColsService = beans.funcColsService;
  ...
  insertOneNode(childNode, details, batchRemover) {
    ...
    if (!parentGroup.group) {
      (0, import_core15._warnOnce)(`duplicate group keys for row data, keys should be unique`, [parentGroup.data, childNode.data]);
    }
...
// enterprise-modules/row-grouping/src/rowGrouping/groupStage/treeStrategy/treeStrategy.ts
var TreeStrategy = class extends import_core16.BeanStub {
  constructor() {
    super(...arguments);
  ...
  getDataPath({ getDataPath }, { data }) {
    ...
    if (!keys.length) {
      (0, import_core16._warnOnce)(`getDataPath() should not return an empty path`, [data]);
    }
    return keys;
  }
  /**
  ...
  commitNodePostOrder(details, parent, node) {
    ...
    if (node.duplicateRows?.size && !node.duplicateRowsWarned) {
      ...
      (0, import_core16._warnOnce)(`duplicate group keys for row data, keys should be unique`, [
        row.id,
        row.data,
  ...
  createFillerRow(node) {
    const row = new import_core17.RowNode(this.beans);
    row.key = node.key;
    row.group = true;
    row.field = null;
    row.leafGroup = false;
    ...
    row.id = import_core17.RowNode.ID_PREFIX_ROW_GROUP + id;
    return row;
  }
...
// enterprise-modules/row-grouping/src/rowGrouping/groupStage/groupStage.ts
var GroupStage = class extends import_core18.BeanStub {
  constructor() {
    super(...arguments);
...
var PivotColDefService = class extends import_core19.BeanStub {
  constructor() {
    super(...arguments);
  ...
  createPivotColumnDefs(uniqueValues) {
    ...
    const pivotColumnDefsClone = pivotColumnDefs.map((colDef) => (0, import_core19._cloneObject)(colDef));
    return {
  ...
  recursivelyBuildGroup(index, uniqueValue, pivotKeys, maxDepth, primaryPivotColumns) {
    ...
    if (measureColumns.length === 1 && this.gos.get("removePivotHeaderRowWhenSingleValueColumn") && index === maxDepth - 1) {
      const leafCols = [];
      (0, import_core19._iterateObject)(uniqueValue, (key) => {
    ...
    const groups = [];
    (0, import_core19._iterateObject)(uniqueValue, (key, value) => {
...
var PivotStage = class extends import_core20.BeanStub {
  constructor() {
    super(...arguments);
  ...
  bucketChildren(children, pivotColumns, pivotIndex, uniqueValues) {
    ...
    children.forEach((child) => {
      ...
      if ((0, import_core20._missing)(key)) {
        key = "";
      }
      if (!uniqueValues[key]) {
    ...
    if (pivotIndex === pivotColumns.length - 1) {
      ...
      const result = {};
      (0, import_core20._iterateObject)(mappedChildren, (key, value) => {
...
var ShowRowGroupColsService = class extends import_core21.BeanStub {
  constructor() {
    super(...arguments);
...
var RowGroupingCoreModule = (0, import_core22._defineModule)({
  version: VERSION,
  moduleName: `${import_core22.ModuleNames.RowGroupingModule}-core`,
  beans: [
    AggregationStage,
  ...
  userComponents: [
    {
      ...
      classImp: import_core23.GroupCellRenderer
    },
    {
  ...
  controllers: [{ name: "groupCellRendererCtrl", classImp: import_core23.GroupCellRendererCtrl }],
  dependantModules: [import_core23.EnterpriseCoreModule]
});
var RowGroupingApiModule = (0, import_core22._defineModule)({
  version: VERSION,
  moduleName: `${import_core22.ModuleNames.RowGroupingModule}-api`,
  apiFunctions: {
    addAggFunc,
    addAggFuncs,
    clearAggFuncs,
...
var GroupFilterModule = (0, import_core22._defineModule)({
  version: VERSION,
  moduleName: "@ag-grid-enterprise/group-filter",
  userComponents: [{ name: "agGroupColumnFilter", classImp: GroupFilter }],
  dependantModules: [RowGroupingCoreModule, import_core22._ColumnFilterModule]
});
var GroupFloatingFilterModule = (0, import_core22._defineModule)({
  version: VERSION,
  ...
  dependantModules: [GroupFilterModule, import_core22._FloatingFilterModule]
});
var RowGroupingModule = (0, import_core22._defineModule)({
  version: VERSION,
  moduleName: import_core22.ModuleNames.RowGroupingModule,
...
var ValuesDropZonePanel = class extends BaseDropZonePanel {
  ...
  postConstruct() {
    ...
    super.init({
      icon: (0, import_core24._createIconNoSpan)("valuePanel", this.gos, null),
      emptyMessage,
      title
    });
