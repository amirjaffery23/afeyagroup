...
var GridLicenseManager = class extends import_core3.BeanStub {
  ...
  validateLicense() {
    this.licenseManager = new LicenseManager((0, import_core3._getDocument)(this.gos));
...
var AgPillContainer = class extends import_core9.Component {
  ...
  onNavigationKeyDown(e) {
    ...
    e.preventDefault();
    const activeEl = (0, import_core9._getActiveDomElement)(this.gos);
    const eGui = this.getGui();
  ...
  clearPills() {
    const eGui = this.getGui();
    if (eGui.contains((0, import_core9._getActiveDomElement)(this.gos)) && this.params.eWrapper) {
  ...
  onPillKeyDown(e) {
    ...
    e.preventDefault();
    const eDoc = (0, import_core9._getDocument)(this.gos);
...
var RichSelectRow = class extends import_core10.Component {
  ...
  populateWithoutRenderer(value, valueFormatted) {
    const eDocument = (0, import_core10._getDocument)(this.gos);
    const eGui = this.getGui();
...
var AgRichSelectList = class extends VirtualList {
  ...
  createLoadingElement() {
    const eDocument = (0, import_core12._getDocument)(this.gos);
    const translate = this.localeService.getLocaleTextFunc();
...
var AgRichSelect = class extends import_core13.AgPickerField {
  ...
  onDeleteKeyDown(e) {
    ...
    const activeEl = (0, import_core13._getActiveDomElement)(gos);
...
var PillDropZonePanel = class extends import_core15.Component {
  ...
  init(params) {
    ...
    this.positionableFeature = new import_core15.PositionableFeature(this.getGui());
  ...
  onTabKeyDown(e) {
    ...
    const { shiftKey } = e;
    const activeEl = (0, import_core15._getActiveDomElement)(this.gos);
  ...
  getFocusedItem() {
    const eGui = this.getGui();
    const activeElement = (0, import_core15._getActiveDomElement)(this.gos);
...
var _AgPanel = class _AgPanel extends import_core16.Component {
  ...
  postConstruct() {
    ...
    this.addManagedElementListeners(this.eTitleBar, {
      mousedown: (e) => {
        if (eGui.contains(e.relatedTarget) || eGui.contains((0, import_core16._getActiveDomElement)(this.gos)) || this.eTitleBarButtons.contains(e.target)) {
          e.preventDefault();
          return;
        }
...
var TabbedLayout = class extends import_core22.TabGuardComp {
  ...
  setupHeader() {
    ...
    if (enableCloseButton) {
      ...
      this.eTabHeader = (0, import_core22._getDocument)(this.gos).createElement("div");
  ...
  setupCloseButton(addCssClasses) {
    const eDocument = (0, import_core22._getDocument)(this.gos);
  ...
  handleKeyDown(e) {
    switch (e.key) {
      ...
      case import_core22.KeyCode.LEFT: {
        if (!this.eTabHeader.contains((0, import_core22._getActiveDomElement)(this.gos))) {
          return;
        }
  ...
  onTabKeyDown(e) {
    ...
    const activeElement = (0, import_core22._getActiveDomElement)(this.gos);
    const target = e.target;
    const backwards = e.shiftKey;
    if (eHeader.contains(activeElement)) {
      ...
      if (enableCloseButton && backwards && !this.eCloseButton?.contains(activeElement)) {
        ...
        this.focusService.findFocusableElementBeforeTabGuard((0, import_core22._getDocument)(this.gos).body, target)?.focus();
      } else {
...
var GroupCellRendererCtrl = class extends import_core23.BeanStub {
  ...
  isTopLevelFooter() {
    const totalRow = (0, import_core23._getGrandTotalRow)(this.gos);
    if (!totalRow) {
      return false;
    }
  ...
  addExpandAndContract() {
    ...
    const setupIcon = (iconName, element) => {
      const icon = (0, import_core23._createIconNoSpan)(iconName, this.gos, null);
      if (icon) {
